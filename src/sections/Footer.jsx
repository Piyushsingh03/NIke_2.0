        ...
        <footer className="max-container">
            <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
                <div className="flex flex-col items-start">
                    ...
                    <p className="text-base mt-6 font-montserrat leading-7  text-white-400 sm:max-w-sm ">Get shoes ready fro the new term at your nearest Nike store. Find Your perfect Size In Store. Get Rewards.</p>
